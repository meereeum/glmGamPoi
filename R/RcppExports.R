...
fisher_scoring_qr_step_export <- function(Y, gene_idx, model_matrix, mu, theta_times_mu) {
    .Call(`_glmGamPoi_fisher_scoring_qr_step_export`, Y, gene_idx, model_matrix, mu, theta_times_mu)
}
